...
// Shared test fixtures. All go through public Alula contracts only —
...
///
/// This is the shape the generated `alulaComponentDescriptors()` produces
...
enum SampleAppModule {
    static let components: [ComponentDescriptor] = [
        ComponentDescriptor(
            typeName: "AlulaActuatorTests.SampleService",
            sourceModule: "SampleAppModule", stereotype: .service),
        ComponentDescriptor(
            typeName: "AlulaActuatorTests.SampleRepository",
            sourceModule: "SampleAppModule", stereotype: .repository),
        ComponentDescriptor(
            typeName: "AlulaActuatorTests.SampleDuplicated",
            sourceModule: "SampleAppModule", stereotype: .component),
        ComponentDescriptor(
            typeName: "AlulaActuatorTests.SampleDuplicated",
            sourceModule: "SampleAppModule", stereotype: .component),
        ComponentDescriptor(
            typeName: "AlulaActuatorTests.SampleMiddleware",
            sourceModule: "SampleAppModule", stereotype: .middleware),
        ComponentDescriptor(
            typeName: "AlulaActuatorTests.SampleSettings",
            sourceModule: "SampleAppModule", stereotype: .settings),
        ComponentDescriptor(
            typeName: "AlulaActuatorTests.SampleController",
...
/// health legitimately reaches `.failed` on a live assembly (Alula Core:
/// configure failures abort bootstrap entirely).
struct FailingServiceModule: AlulaModule {
