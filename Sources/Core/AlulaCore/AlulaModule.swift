...
public protocol AlulaModule {
    ...
    static var defaultProviders: [any AlulaModule.Type] { get }
...
extension AlulaModule {
    /// Nothing nominated: the ordinary case, where each type has one provider.
    public static var defaultProviders: [any AlulaModule.Type] { [] }
...
/// Tracked externally by bootstrap — `AlulaModule` stays unchanged. Coarse
