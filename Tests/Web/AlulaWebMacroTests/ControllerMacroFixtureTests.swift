// Alula Web §4 — controller macro expansions, pinned as fixtures.
//
// Same discipline as AlulaCoreMacroTests: these expected strings are the
// normative expansion spec; the design doc's prose examples are
// illustrative. The runtime integration suite (AlulaWebTests) proves the
...
@testable import AlulaWebMacrosImpl
...
struct ControllerMacroFixtureTests {
    ...
    func getHandlerExpansion() {
        assertMacroExpansion(
            ...
            struct HealthController {
                ...
                static func _alulaRoute_health_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "/health", kind: .http, source: String(reflecting: Self.self) + ".health") { context in
                ...
                static func alulaRoutes(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> [AlulaWeb.RouteRegistration] {
                    [
                        Self._alulaRoute_health_0(make)
                    ]
                }
            }
            """,
    ...
    func bodyAndVoidHandlers() {
        ...
        // the `alulaRoutes` aggregate mirror the type (`public`), but the
        ...
        // therefore goes through `alulaRoutes`; naming one factory from
        ...
        assertMacroExpansion(
            ...
            public struct UserController {
                ...
                static func _alulaRoute_createUser_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "POST", path: "/users", kind: .http, source: String(reflecting: Self.self) + ".createUser") { context in
                        let controller = try make(context)
                        let body = try AlulaWeb.decodeRequestBody(CreateUserRequest.self, from: context)
                        let result = try await controller.createUser(context, body: body)
                        return try AlulaWeb.encodeResponse(result, for: context)
                    }
                }

                static func _alulaRoute_deleteUser_1(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "DELETE", path: "/users/:id", kind: .http, source: String(reflecting: Self.self) + ".deleteUser") { context in
                        let controller = try make(context)
                        try controller.deleteUser(context)
                        return AlulaWeb.Response.noContent
                    }
                }

                public static func alulaRoutes(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> [AlulaWeb.RouteRegistration] {
                    [
                        Self._alulaRoute_createUser_0(make),
                                Self._alulaRoute_deleteUser_1(make)
                    ]
                }
            }
            """,
    ...
    func webSocketMappingExpansion() {
        assertMacroExpansion(
            ...
            struct ChatController {
                ...
                static func _alulaRoute_chat_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "/chat/:roomId", kind: .upgrade(.webSocket), source: String(reflecting: Self.self) + ".chat") { context in
                        let controller = try make(context)
    ...
    func invalidPathPatternIsAnError() {
        assertMacroExpansion(
            ...
            struct BadController {
                ...
                static func _alulaRoute_handler_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "users", kind: .http, source: String(reflecting: Self.self) + ".handler") { context in
                        let controller = try make(context)
                ...
                static func alulaRoutes(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> [AlulaWeb.RouteRegistration] {
                    [
                        Self._alulaRoute_handler_0(make)
                    ]
                }
            }
            """,
    ...
    func controllerBasePathCombinesWithMethodPaths() {
        ...
        // `alulaRoutes` is what the macro actually emits — `routesAggregate`
        ...
        assertMacroExpansion(
            ...
            struct UserController {
                ...
                static func _alulaRoute_index_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "/users", kind: .http, source: String(reflecting: Self.self) + ".index") { context in
                        let controller = try make(context)
                ...
                static func _alulaRoute_show_1(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                ...
                static func alulaRoutes(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> [AlulaWeb.RouteRegistration] {
                    [
                        Self._alulaRoute_index_0(make),
                                Self._alulaRoute_show_1(make)
                    ]
                }
            }
            """,
    ...
    func controllerPathMustStartWithSlash() {
        assertMacroExpansion(
            ...
            struct BadController {
                ...
                static func _alulaRoute_show_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "/:id", kind: .http, source: String(reflecting: Self.self) + ".show") { context in
                        let controller = try make(context)
                        let result = controller.show(context)
                        return try AlulaWeb.encodeResponse(result, for: context)
                    }
    ...
    func controllerPathNonLiteralIsAnError() {
        assertMacroExpansion(
            ...
            struct BadController {
                ...
                static func _alulaRoute_handler_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "/x", kind: .http, source: String(reflecting: Self.self) + ".handler") { context in
                        let controller = try make(context)
                        let result = controller.handler(context)
                        return try AlulaWeb.encodeResponse(result, for: context)
                    }
    ...
    func routeInheritsControllerPipelines() {
        assertMacroExpansion(
            ...
            struct DashboardController {
                ...
                static func _alulaRoute_admin_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "/dashboard/admin", kind: .http, source: String(reflecting: Self.self) + ".admin", pipelines: [.authenticated]) { context in
                        let controller = try make(context)
    ...
    func routePipelinesReplaceControllers() {
        assertMacroExpansion(
            ...
            struct DashboardController {
                ...
                static func _alulaRoute_index_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "/dashboard", kind: .http, source: String(reflecting: Self.self) + ".index", pipelines: [.public]) { context in
                        let controller = try make(context)
                        let result = controller.index(context)
                        return try AlulaWeb.encodeResponse(result, for: context)
                    }
    ...
    func narrowingAwayAuthenticationWarns() {
        assertMacroExpansion(
            ...
            struct DashboardController {
                ...
                static func _alulaRoute_index_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "/dashboard", kind: .http, source: String(reflecting: Self.self) + ".index", pipelines: ["metrics"]) { context in
                        let controller = try make(context)
                        let result = controller.index(context)
                        return try AlulaWeb.encodeResponse(result, for: context)
                    }
    ...
    func swappingSecurityLanesDoesNotWarn() {
        assertMacroExpansion(
            ...
            struct DashboardController {
                ...
                static func _alulaRoute_index_0(_ make: @escaping @Sendable (AlulaWeb.RequestContext) throws -> Self) -> AlulaWeb.RouteRegistration {
                    AlulaWeb.RouteRegistration(method: "GET", path: "/dashboard", kind: .http, source: String(reflecting: Self.self) + ".index", pipelines: [.authentication]) { context in
                        let controller = try make(context)
                        let result = controller.index(context)
                        return try AlulaWeb.encodeResponse(result, for: context)
                    }
