...
/// `swift-certificates` draws for X.509: the primitive is delegated, Flight
...
public struct Argon2idHashing: PasswordHashing {
    ...
    ///
    /// Read the algorithm's own naming rather than Flight's elsewhere:
    ...
    public struct Parameters: Sendable, Equatable {
        ...
        /// flight*, not just this much time.
    ...
    /// Everything here is Flight's own, deliberately minimal parsing of a
    /// string Flight itself produced — this is not a general PHC
