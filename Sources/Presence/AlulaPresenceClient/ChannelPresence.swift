...
/// channel's message stream, applies `alula:presence_state` /
/// `alula:presence_diff` payloads through the shared `PresenceSync` rules,
...
/// `join`, the normal shape), so a fresh `alula:presence_state` arrives
