...
@attached(
    member, names: named(init), named(_alulaScheduledJobs))
public macro Scheduler() =
    #externalMacro(module: "AlulaSchedulerMacrosImpl", type: "SchedulerMacro")
...
) = #externalMacro(module: "AlulaSchedulerMacrosImpl", type: "ScheduledMacro")
