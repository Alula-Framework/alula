...
/// that the generated `init(_alula:)` suppresses that, which is why it has
...
public func parameterizedInitializer(
    ...
    if !configured.isEmpty {
        parameters.insert("_alulaConfiguration configuration: AlulaCore.Configuration", at: 0)
        labels.insert("_alulaConfiguration", at: 0)
    }
