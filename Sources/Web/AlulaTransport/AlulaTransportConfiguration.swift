...
/// `AlulaTransport`'s settings, read from the app-wide Alula configuration
/// (alula.yaml / ALULA_* environment variables) under `server.*`:
///
...
/// supported deployment — leave these keys out and Alula serves plaintext
/// to the proxy.
///
...
public struct AlulaTransportConfiguration: ServerTransportConfiguration {
    ...
    private static func readTLS(from configuration: AlulaCore.Configuration) throws -> TLS? {
