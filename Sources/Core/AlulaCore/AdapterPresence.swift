...
///
/// Several Alula features pick their implementation by whether an adapter
...
/// `cache.valkey.url`, the module list does not say `AlulaCacheValkeyModule`,
...
extension Configuration {
    ...
    ///         feature: "cache",
    ///         candidates: [.init(configurationKey: "cache.valkey.url", module: "AlulaCacheValkeyModule")])
    /// }
    /// ```
    ///
    /// - Parameters:
...
public struct UnloadedAdapterError: Error, Sendable, Equatable, CustomStringConvertible {
    ...
    public var description: String {
        ...
        read. Add \(module) to Alula.bootstrap(modules:), or remove the '\(configurationKey)' \
