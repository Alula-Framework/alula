...
/// A trivial second `AlulaModule` conformance: proves the abstraction is not
/// secretly shaped around the web module. Holds one component, owns no service.
public struct LoggingModule: AlulaModule {
...
public struct FakeServerModule: AlulaModule {
    public static var dependencies: [any AlulaModule.Type] { [LoggingModule.self] }
...
public struct FailingServiceModule: AlulaModule {
    public init() {}
...
public struct OneShotModule: AlulaModule {
