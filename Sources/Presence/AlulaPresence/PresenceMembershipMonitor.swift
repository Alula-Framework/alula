...
/// adapter module (the SWIM adapter, PubSub) provides so Presence
...
///
/// An adapter module provides a conformance; the composition root wires it
/// into `AlulaPresenceModule`, which then runs in membership mode. Without
/// one — the Valkey-style
