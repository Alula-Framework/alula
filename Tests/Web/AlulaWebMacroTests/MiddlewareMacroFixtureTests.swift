...
// `AlulaWeb.Middleware` is the one conformance left: the container's
// `_AlulaRegistrable` marker protocol went with the container, so the
...
private let testMacros: [String: MacroSpec] = [
    "Middleware": MacroSpec(
        ...
        conformances: ["AlulaWeb.Middleware"]),
    ...
    func plainMiddleware() {
        ...
        assertMacroExpansion(
            ...
            expandedSource: """
                ...
                extension RequestTiming: AlulaWeb.Middleware {
                }
                """,
    ...
    func withDependencies() {
        assertMacroExpansion(
            ...
            expandedSource: """
                ...
                extension Transactions: AlulaWeb.Middleware {
                }
                """,
            macroSpecs: testMacros
        )
    ...
    func noArguments() {
        assertMacroExpansion(
            ...
            expandedSource: """
                ...
                extension Plain: AlulaWeb.Middleware {
                }
                """,
            macroSpecs: testMacros
        )
    ...
    func ambiguousInjectIsRejected() {
        assertMacroExpansion(
            ...
            expandedSource: """
                ...
                extension Fanout: AlulaWeb.Middleware {
                }
                """,
            diagnostics: [
                DiagnosticSpec(
